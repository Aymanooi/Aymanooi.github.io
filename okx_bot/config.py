...
USE_MAX_LEVERAGE = True    # أقصى رافعة/عملة (طلب المستخدم المتكرّر، مسؤولية كاملة، مال صغير)
...
# 0.06 = سقف فعلي ≈ x16 (لا تصفية إلا بفجوة سعرية ≥ 6%) — حماية أساسية
# مطلوبة عند إعادة تفعيل البوت بعد إيقافه.
LIQ_GAP_BUFFER = 0.06
