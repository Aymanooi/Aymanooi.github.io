...
# مخارج rocket الموثقة («الأقل سوءاً تجريبياً»: x3، SL 2%، TP 4%) —
# طلب المستخدم الصريح: الهدف ضعف الوقف (1:2). الرسوم ~1.75% من الهدف.
STOP_LOSS_PCT   = 0.02
...
# 0.05 = سقف فعلي x20 (لا تصفية إلا بفجوة سعرية ≥ 5%) — يسمح برافعة
# البوت القديم x20 كاملة ويمنع القفز إلى x50-100.
LIQ_GAP_BUFFER = 0.05
