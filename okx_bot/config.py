...
#   "balanced"   = متوازن: رافعة 15×، مخاطرة 5%، مركزان متزامنان
...
_RISK_PRESETS = {
    ...
    "balanced":   {"leverage": 15, "risk_per_trade": 0.05, "kelly_cap": 0.15, "half_kelly": True,  "symbols": 50,  "filter_losers": False, "max_positions": 2},
