...
TAKE_PROFIT_PCT = 0.015   # هدف الربح: 1.5% — القيمة الرابحة بالبيانات (PF 1.08)
...
USE_MAX_LEVERAGE = False   # الكسب يتطلّب x3 المثلى لا القصوى (القصوى تُصفّي — أثبتته البيانات)
