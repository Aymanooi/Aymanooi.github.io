...
STOP_LOSS_PCT   = 0.015   # وقف الخسارة: 1.5% (إعداد الفوز العالي المُثبَت)
TAKE_PROFIT_PCT = 0.007   # هدف الربح: 0.7% — فوز 72%، PF 1.08 مع البوّابة
...
USE_MAX_LEVERAGE = False   # x3 المثلى (أقصى رافعة تُصفّي — أثبتته البيانات)
...
REGIME_MAX_AGE= 3600    # تتقادم بعد ساعة (تمنع التجمّد، تستأنف التجربة)
